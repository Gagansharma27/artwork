    ...
    <div>
      <footer className="dark:bg-jacarta-900 page-footer bg-white">
        <div className="container">
          <div className="grid grid-cols-6 gap-x-7 gap-y-14 pt-24 pb-12 md:grid-cols-12">
            <div className="col-span-3 md:col-span-6">
              ...
              <Link href="#">
                <a className="mb-6 inline-block">
                  <img
                    ...
                    alt="ArtFactory721 | Artists Marketplace"
                  />
                </a>
              </Link>
              ...
              <p className="dark:text-jacarta-300 mb-12">
                artFactory721.com <br /> CH-4000 Basel
                <br />
            ...
            {footerMenuList.map((single) => (
                ...
                <div
                  className={`col-span-full sm:col-span-4 md:col-span-2 ${single.diffClass}`}
                  key={single.id}
                >
          ...
          <div className="flex space-x-5 row-reverse">
          ...
          <div className="flex flex-col items-center justify-between space-y-2 py-8 sm:flex-row sm:space-y-0">
            ...
            <span className="dark:text-jacarta-400 text-sm">
              <span>
                © {new Date().getFullYear()} ArtFactory721.com — All Rights
                Reserved
              </span>
            </span>
            <span className="dark:text-jacarta-400 text-sm">
              <span>© Powered by factory721.com</span>
            </span>
          </div>
        </div>
      </footer>
