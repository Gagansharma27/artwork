						...
						<SwiperSlide key={id}>
							<article>
								<Link href="/collection/explore_collection">
									<a className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
										<figure
