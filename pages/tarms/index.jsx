...
const Tarms = () => {
  return (
    <div>
      <Meta title="Tarms || ArtFactory721 | Artists Marketplace " />
        ...
        <section className="dark:bg-jacarta-800 relative py-16 md:py-24">
          ...
          <div className="container">
            ...
            <div className="article-content mx-auto max-w-[48.125rem]">
              ...
              <p>
                ArtFactory721 is not a wallet provider, exchange, broker,
                financial institution, or creditor. ArtFactory721 provides a
                peer-to-peer web3 service that helps users discover and directly
                interact with each other and NFTs available on public
              ...
              <p>
                ...
                including, without limitation, the ArtFactory721 logo and all
                designs, text, graphics, pictures, data, software, sound files,
                other files, and the selection and arrangement thereof are the
                proprietary property of ArtFactory721 or our affiliates,
                licensors, or users, as applicable, and you agree not to take
              ...
              <p>
                ...
                ArtFactory721 relating to your access to and use of the Service.
                ...
                consent of ArtFactory721, and ArtFactory721’s failure to assert
                any right or provision under these Terms shall not constitute a
                waiver of such right or provision. No waiver by either party of
                any breach or default hereunder shall be deemed to be a waiver
                of any preceding or subsequent breach or default. The section
              ...
              <p>
                ...
                compliance with applicable local laws. You and ArtFactory721
